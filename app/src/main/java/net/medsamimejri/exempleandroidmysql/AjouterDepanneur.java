...
public class AjouterDepanneur extends Activity {
    public static final String strURL = "http://10.0.2.2:8080/Tunisie_Telecom/AjoutDepanneur.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ajouter_depanneur);
        ...
        ajouter.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (cin.getText().toString().equals("")) {
                    ...
                    adb.setMessage("saisir Cin Dépanneur");
                    ...
                    AlertDialog.Builder adb = new AlertDialog.Builder(
                            AjouterDepanneur.this);
                    adb.setTitle("Vérifier");
                    adb.setMessage("saisir Nom & Prénom Dépanneur");
                    adb.setPositiveButton("Ok", null);
                    adb.show();
                    ...
                    AlertDialog.Builder adb = new AlertDialog.Builder(
                            AjouterDepanneur.this);
                    adb.setTitle("Vérifier");
                    adb.setMessage("saisir N° Tel Dépanneur");
                    adb.setPositiveButton("Ok", null);
                    adb.show();
                    NTel.requestFocus();
                    ...
                    AlertDialog.Builder adb = new AlertDialog.Builder(
                            AjouterDepanneur.this);
                    adb.setTitle("Vérifier");
                    adb.setMessage("saisir Mot De Passe Dépanneur");
                    adb.setPositiveButton("Ok", null);
                    adb.show();
